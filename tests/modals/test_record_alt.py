...
def record_modal(monkeypatch, request):
    ...
    monkeypatch.setattr(record, "record_template", mock.Mock())
    monkeypatch.setattr(record.RecordTemplate, "get_all", classmethod(lambda cls: []))
    monkeypatch.setattr(record.RecordTemplate, "query", mock.Mock())
